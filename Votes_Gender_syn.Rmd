...
title: "Show of Hands:Votes: Party classification:: Votes_Gender"
author: "bdanalytics"
...
#       work each one in
    , "USER_ID", "YOB", "Gender" # Done
    ,"Income", "HouseholdStatus", "EducationLevel"
    ,"Q124742","Q124122"
    ,"Q123621","Q123464"
...
glbFeatsDerive[["YOB.Age.fctr"]] <- list(
    mapfn = function(YOB) {
        ...
        return(relevel(as.factor(retVal), ref = "NA"))
    }
    , args = c("YOB"))
...
#load("Votes_Gender_extract.features.end.RData", verbose = TRUE)
