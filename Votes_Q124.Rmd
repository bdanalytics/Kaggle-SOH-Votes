...
title: "Show of Hands:Votes: Party classification:: Votes_Q124"
author: "bdanalytics"
...
for (qsn in c("Q124742","Q124122"))
    glbFeatsDerive[[paste0(qsn, ".fctr")]] <- list(
        mapfn = function(raw1) {
            ...
            if (length(setdiff(unique(raw1), c("NA", "No", "Ys"))) > 0)
                stop(qsn, " vals: ", unique(raw1), 
...
#load("Votes_Q124_extract.features.end.RData", verbose = TRUE)
