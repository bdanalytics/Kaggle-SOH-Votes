...
title: "Show of Hands:Votes: Party classification:: Q109244No_AllXpreProc_cnk02_fit.models_1"
author: "bdanalytics"
...
glbOut <- list(pfx = "Q109244No_AllXpreProc_cnk02_fit.models_1_")
...
glbChunks[["last" ]] <- "fit.models_1" # NULL # default: script will save envir at end of this chunk 
...
```{r fit.models_1, cache=FALSE, echo=FALSE, eval=myevlChunk(glbChunks, glbOut$pfx, keepSpec = c("glbMdlFamilies", "glbMdlAllowParallel"), dropSpec = c(NULL))}
#myloadChunk(glbChunks$inpFilePathName, keepSpec = c("glbMdlFamilies","glbMdlAllowParallel"), dropSpec = c(NULL)); glb2Sav()
