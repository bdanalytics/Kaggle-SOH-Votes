...
title: "Show of Hands:Votes: Party classification:: Q109244No_AllXpreProc_cnk03_cluster.data"
author: "bdanalytics"
...
glbOut <- list(pfx = "Q109244No_AllXpreProc_cnk03_cluster.data_")
...
glbChunks[["last" ]] <- "cluster.data" # NULL # default: script will save envir at end of this chunk 
...
```{r scrub.data, cache=FALSE, echo=FALSE, eval=myevlChunk(glbChunks, glbOut$pfx, keepSpec = c("glbMdlTuneParams","glbFeatsCategory","glb_dsp_cols","glbMdlPreprocMethods"), dropSpec = c(NULL))}
