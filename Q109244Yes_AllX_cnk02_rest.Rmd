...
title: "Show of Hands:Votes: Party classification:: Q109244Yes_AllX_cnk02_rest"
author: "bdanalytics"
...
glbOut <- list(pfx = "Q109244Yes_AllX_cnk02_rest_")
...
glbChunks[["inpFilePathName"]] <- "data/Q109244Yes_AllX_manage.missing.data_manage.missing.data.RData" # NULL: default or "data/<prvScriptName>_<lstChunkLbl>.RData"
...
```{r scrub.data, cache=FALSE, echo=FALSE, eval=myevlChunk(glbChunks, glbOut$pfx, keepSpec = c("glbMdlFamilies", "glbMdlTuneParams","glbFeatsCategory","glb_dsp_cols","glbMdlPreprocMethods","glbMdlSelId","glbMdlSequential"), dropSpec = c(NULL))}
#myloadChunk(glbChunks$inpFilePathName, keepSpec = c("glbMdlFamilies", "glbMdlTuneParams","glbFeatsCategory","glb_dsp_cols","glbMdlPreprocMethods","glbMdlSelId","glbMdlSequential"), dropSpec = c(NULL)); glb2Sav()
...
## Step ``r mydsp_chunk(glb_chunks_df)``
```{r cluster.data, cache=FALSE, echo=FALSE, eval=myevlChunk(glbChunks, glbOut$pfx, keepSpec = c("glbMdlTuneParams"), dropSpec = c(NULL))}
if (!is.null(glbChunks$first) && (glbChunks$first == "cluster.data") &&
    (is.null(knitr::opts_current$get(name = 'label')))) # not knitting
    myloadChunk(glbChunks$inpFilePathName, keepSpec = c("glbMdlTuneParams"), dropSpec = c(NULL))
...
```{r fit.models_1, cache=FALSE, echo=FALSE, eval=myevlChunk(glbChunks, glbOut$pfx, keepSpec = c("glbMdlFamilies","glbMdlSequential","glbMdlPreprocMethods","glbMdlTuneParams","glbMdlSelId","glbMdlEnsemble"), dropSpec = c(NULL))}
...
```{r fit.models_2, cache=FALSE, echo=FALSE, eval=myevlChunk(glbChunks, glbOut$pfx, keepSpec = c("glbMdlSequential", "glbMdlEnsemble", "glbMdlMetricsEval", "glbMdlTuneParams"), dropSpec = c(NULL))}
#myloadChunk(glbChunks$inpFilePathName, keepSpec = c("glbMdlSequential", "glbMdlEnsemble", "glbMdlMetricsEval", "glbMdlTuneParams"), dropSpec = c(NULL)); glb2Sav()
