...
title: "Show of Hands:Votes: Party classification:: Votes_YOB"
author: "bdanalytics"
...
glbFeatsCategory <- "YOB.Age.fctr" # choose from c(NULL : default, "<category_feat>")
...
#load("Votes_YOB_extract.features.end.RData", verbose = TRUE)
