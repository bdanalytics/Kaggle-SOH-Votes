...
title: "Show of Hands:Votes: Party classification:: Votes_Ensemble_cnk06"
author: "bdanalytics"
...
glbMdlAllowParallel[["Final.All.X#ica#rcv#glmnet"]] <- FALSE

glbMdlAllowParallel[["Ensemble.auto##boot#glmnet"]] <- FALSE
glbMdlAllowParallel[["Ensemble.auto##boot632#glmnet"]] <- FALSE
glbMdlAllowParallel[["Ensemble.auto##rcv#glm"]] <- FALSE
glbMdlAllowParallel[["Ensemble.auto.2##boot#glmnet"]] <- FALSE
glbMdlAllowParallel[["Ensemble.auto.2##boot632#glmnet"]] <- FALSE
...
glbOut <- list(pfx = "Votes_Ensemble_cnk06_")
...
glbChunks[["first"]] <- "fit.models_2" #default: script will load envir from previous chunk
glbChunks[["last" ]] <- NULL # NULL #default: script will save envir at end of this chunk 
glbChunks[["inpFilePathName"]] <- "data/Votes_RFEXNOr_cnk05_fit.models_1_nomdllst.RData" # "data/<prvScriptName>_<lstChunkLbl>.RData"
