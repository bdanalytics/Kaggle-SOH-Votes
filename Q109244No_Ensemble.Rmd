...
title: "Show of Hands:Votes: Party classification:: Q109244No_Ensemble"
author: "bdanalytics"
...
glbMdlAllowParallel[["All.X.Inc##rcv#glm"]] <- FALSE

glbMdlAllowParallel[["RFE.X##rcv#svmRadial"]] <- FALSE
...
RFEX_nzv_rcv_glmnetTuneParams <- rbind(data.frame()
    ,data.frame(parameter = "alpha",  vals = "0.05 0.100 0.325 0.550 0.775")
    ,data.frame(parameter = "lambda", vals = "0.0003760587 0.0017455100 0.0081019397 0.0376058727")
                        ) # max.Accuracy.OOB = 0.5979798 @ 0.1 0.00810194
glbMdlTuneParams <- rbind(glbMdlTuneParams
    ...
    ,cbind(data.frame(mdlId = "RFE.X#nzv#rcv#glmnet"),         RFEX_nzv_rcv_glmnetTuneParams)
)
...
glbOut <- list(pfx = "Q109244No_Ensemble_")
...
glbChunks[["inpFilePathName"]] <- "data/Q109244No_AllXNOr_cnk01_fit.models_1_fit.models_1.RData" # NULL: default or "data/<prvScriptName>_<lstChunkLbl>.RData"
...
```{r scrub.data, cache=FALSE, echo=FALSE, eval=myevlChunk(glbChunks, glbOut$pfx, keepSpec = c("glbMdlFamilies", "glbMdlTuneParams","glbFeatsCategory","glb_dsp_cols","glbMdlPreprocMethods","glbMdlSelId","glbMdlAllowParallel"), dropSpec = c(NULL))}
#myloadChunk(glbChunks$inpFilePathName, keepSpec = c("glbMdlFamilies", "glbMdlTuneParams","glbFeatsCategory","glb_dsp_cols","glbMdlPreprocMethods","glbMdlSelId","glbMdlAllowParallel"), dropSpec = c(NULL)); glb2Sav()
...
```{r fit.models_1, cache=FALSE, echo=FALSE, eval=myevlChunk(glbChunks, glbOut$pfx, keepSpec = c("glbMdlFamilies","glbMdlAllowParallel","glbMdlPreprocMethods","glbMdlTuneParams","glbMdlSelId","glbMdlEnsemble"), dropSpec = c(NULL))}
#myloadChunk(glbChunks$inpFilePathName, keepSpec = c("glbMdlFamilies","glbMdlAllowParallel","glbMdlPreprocMethods","glbMdlTuneParams","glbMdlSelId","glbMdlEnsemble"), dropSpec = c(NULL)); glb2Sav()
