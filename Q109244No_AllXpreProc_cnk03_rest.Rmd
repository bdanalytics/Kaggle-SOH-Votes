...
title: "Show of Hands:Votes: Party classification:: Q109244No_AllXpreProc_cnk03_rest"
author: "bdanalytics"
...
glbOut <- list(pfx = "Q109244No_AllXpreProc_cnk03_rest_")
...
glbChunks[["first"]] <- "fit.data.training_0" # NULL # default: script will load envir from previous chunk
glbChunks[["last" ]] <- NULL # default: script will save envir at end of this chunk 
glbChunks[["inpFilePathName"]] <- "data/Q109244No_AllXpreProc_cnk03_fit.models_3_fit.models_3.RData" # NULL: default or "data/<prvScriptName>_<lstChunkLbl>.RData"
...
```{r scrub.data, cache=FALSE, echo=FALSE, eval=myevlChunk(glbChunks, glbOut$pfx, keepSpec = c("glbMdlFamilies", "glbMdlTuneParams"), dropSpec = c(NULL))}
...
#myloadChunk(glbChunks$inpFilePathName, keepSpec = c("glbMdlAllowParallel","glbMdlFamilies","glbMdlSelId"), dropSpec = c(NULL)); glb2Sav()
...
for (family in names(glbMdlPreprocMethods)) {
