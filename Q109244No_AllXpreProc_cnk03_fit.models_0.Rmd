...
title: "Show of Hands:Votes: Party classification:: Q109244No_AllXpreProc_cnk03_fit.models_0.data"
author: "bdanalytics"
...
glbOut <- list(pfx = "Q109244No_AllXpreProc_cnk03_fit.models_0.data_")
...
glbChunks[["last" ]] <- "fit.models_0" # NULL # default: script will save envir at end of this chunk 
...
```{r scrub.data, cache=FALSE, echo=FALSE, eval=myevlChunk(glbChunks, glbOut$pfx, keepSpec = c("glbMdlFamilies","glbMdlTuneParams","glbFeatsCategory","glb_dsp_cols","glbMdlPreprocMethods"), dropSpec = c(NULL))}
#myloadChunk(glbChunks$inpFilePathName, keepSpec = c("glbMdlFamilies", "glbMdlTuneParams","glbFeatsCategory","glb_dsp_cols","glbMdlPreprocMethods"), dropSpec = c(NULL)); glb2Sav()
...
if (bstMdlIdComponents$preProcess == "") {
    ...
    for (mdlPrepr in glbMdlPreprocMethods[[bstMdlIdComponents$family]][[bstMdlIdComponents$alg]]) {
        ret_lst <- myfit_mdl(mdl_specs_lst = myinit_mdl_specs_lst(mdl_specs_lst = list(
