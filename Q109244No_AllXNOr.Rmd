...
title: "Show of Hands:Votes: Party classification:: Q109244No_AllXNOr"
author: "bdanalytics"
...
glbOut <- list(pfx = "Q109244No_AllXNOr_")
...
glbChunks[["inpFilePathName"]] <- "data/Q109244No_AllXpreProc_cnk04_fit.models_1_fit.models_1.RData" # NULL: default or "data/<prvScriptName>_<lstChunkLbl>.RData"
...
```{r fit.models_1, cache=FALSE, echo=FALSE, eval=myevlChunk(glbChunks, glbOut$pfx, keepSpec = c("glbMdlFamilies","glbMdlAllowParallel","glbMdlPreprocMethods","glbMdlTuneParams","glbMdlSelId"), dropSpec = c(NULL))}
#myloadChunk(glbChunks$inpFilePathName, keepSpec = c("glbMdlFamilies","glbMdlAllowParallel","glbMdlPreprocMethods","glbMdlTuneParams","glbMdlSelId"), dropSpec = c(NULL)); glb2Sav()
