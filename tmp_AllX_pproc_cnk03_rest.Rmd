...
title: "Show of Hands:Votes: Party classification:: Votes_AllX_pproc_cnk03_rest"
author: "bdanalytics"
...
glbOut <- list(pfx = "Votes_AllX_pproc_cnk03_rest_")
...
tmpprint_mdl <- function(mdl) {
    ...
    if (inherits(lcl_mdl, "glmnet")) {
        print("tmpprint_mdl: x$beta:"); print(lcl_mdl$beta)
        print("tmpprint_mdl: x$lambda:"); print(lcl_mdl$lambda)
        print("tmpprint_mdl: x$df:"); print(lcl_mdl$df)
        print("tmpprint_mdl: x$dev.ratio:"); print(lcl_mdl$dev.ratio)
        
        x <- lcl_mdl; label = FALSE; xvar = "norm"
        plotCoef(x$beta, lambda = x$lambda, df = x$df, dev = x$dev.ratio, 
                 label = label, xvar = xvar)
        
        plot(lcl_mdl, xvar = "lambda", ask = FALSE)
...
tmpprint_mdl(glb_sel_mdl <- glb_models_lst[[glbMdlSelId]])
```